  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "gradient-primary text-white font-bold hover:scale-105 glow-primary transition-bounce shadow-lg",
        roast: "gradient-roast text-white font-semibold hover:scale-110 glow-accent transition-bounce border border-accent/30",
        gaming: "bg-card border border-primary/50 text-foreground hover:bg-primary/10 hover:border-primary transition-smooth glow-primary/50"
      },
      size: {
